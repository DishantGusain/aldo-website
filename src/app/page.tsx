export default function Home() {
   return (
      <div className="w-full flex justify-center font-montserrat font-medium">
         <div className="max-w-screen-2xl w-full min-h-screen  space-y-12 py-10 px-4">
            {/* --------------- HEADER --------------- */}
            ...
            <div className="text-xl space-y-10">
               <h2 className="">
                  ...
                  Solutions for Over <span className="font-bold">15 Years!</span>
               </h2>
               ...
               <div className="w-full justify-center flex flex-col items-center space-y-14">
                  <a href="aldo-form" className="bg-[#ff550d] px-16 xl:px-32 py-3 text-white font-semibold rounded hover:bg-red-500 duration-300 cursor-pointer text-2xl">
                     Get Started
                  </a>
                  <p className="text-sm">
